...
/** הסברים אמיתיים לפריטי «מה כלול» — במקום חזרה על השם */
const INCLUDE_DESCRIPTIONS = {
  "מוזיקה מותאמת": "פלייליסט לפי סגנון האירוע ובקשות מראש מהזוג/מארגנים.",
  מיקרופון: "מיקרופון אלחוטי לקבלת פנים, ברכות וטקס.",
  "מיקרופון MC": "מיקרופון ייעודי למנחה האירוע לאורך הערב.",
  "תאורת מסיבות": "תאורת רחבה בסיסית לרחבת הריקודים.",
  "פלייליסט מותאם": "התאמת רשימת שירים מראש + שינויים בזמן אמת.",
  "תאורת במה": "תאורת במה מקצועית לרחבה ולנקודות מרכזיות.",
  "אפקטי עשן": "מכונת עשן לרגעי שיא ברחבה (לפי אישור האולם).",
  "טכנאי לייט": "טכנאי תאורה באירוע לניהול המעברים והאפקטים.",
  "גלריה מקוונת": "גלריה דיגיטלית מאובטחת להורדת התמונות אחרי האירוע.",
  "6 שעות כיסוי": "כיסוי צילום רציף עד 6 שעות ביום האירוע.",
  "מפגש היכרות": "פגישת תיאום לפני האירוע לתיאום סגנון ולו״ז.",
  "USB עם כל התמונות": "מסירת כל הקבצים באיכות מלאה על גבי USB.",
  "2 צלמים": "שני צלמים במקביל לכיסוי טקס, קבלת פנים ורחבה.",
  "אלבום מודפס": "אלבום מודפס בעיצוב אישי (מספר עמודים לפי חבילה).",
  "עריכה מתקדמת": "עריכת צבע וסגנון אחיד לכל הגלריה.",
  "זר כלה": "זר כלה מותאם לסגנון ולפלטת הצבעים.",
  "חופה בסיסית": "עיצוב חופה בסיסי בפרחים וירק.",
  "סידור חופה": "עיצוב מלא לחופה כולל בסיס ופרחים.",
  "2 סידורי שולחן VIP": "שני סידורי שולחן מוגברים לאורחי כבוד.",
  "קיר פרחים": "קיר/רקע פרחים לצילומים ולכניסה.",
  "חופה מורכבת": "חופה בעיצוב מורכב עם אלמנטים מיוחדים.",
  "סידורי VIP": "סידורי שולחן מוגברים לשולחנות כבוד.",
  "ניסיון איפור": "ניסיון איפור לפני היום הגדול לכיוון מדויק.",
  ריסים: "התקנת ריסים כחלק מהאיפור.",
  "ליווי עד היציאה": "ליווי וטאצ׳־אפים עד היציאה לחופה/לאירוע.",
  "אם כלה": "איפור לאם הכלה כחלק מהחבילה.",
  תיקונים: "תיקוני איפור במהלך היום לפי הצורך.",
  "מוצרי פרימיום": "שימוש במוצרי איפור ואיפור קבע באיכות גבוהה.",
  "תפריט טעימות": "פגישת טעימות לתפריט לפני הזמנה סופית.",
  "תפריט ילדים": "מנות מותאמות לילדים כחלק מההגשה.",
  "עמדת סלטים": "עמדת סלטים טריים במקביל למנות העיקריות.",
  "פגישות תכנון": "פגישות תכנון לו״ז ותיאום ספקים לפני האירוע.",
  "לו״ז מפורט": "לוח זמנים מפורט ליום האירוע לכל הספקים.",
  "ניהול יום האירוע": "ניהול שוטף ביום האירוע מול האולם והספקים.",
  "קליפ 3–5 דקות": "קליפ ערוך באורך 3–5 דקות מיום האירוע.",
  "צילום טקס": "כיסוי מלא של הטקס כולל זוויות מרכזיות.",
  "מוזיקה מורשית": "שימוש במוזיקה מורשית לקליפ.",
  "פגישת תיאום": "פגישת תיאום מראש לסגנון ההנחיה וללו״ז.",
  "הנחיית טקס": "הנחיית הטקס והמעברים המרכזיים.",
  "משחקי קהל": "משחקי קהל קצרים לפי אופי האירוע.",
  "פגישת טעימות": "טעימות טעמים ועיצוב לפני הזמנה.",
  "עיצוב אישי": "עיצוב עוגה לפי קונספט ופלטת צבעים.",
  "משלוח לאולם": "משלוח והצבה באולם ביום האירוע.",
};

function toIncludeRow(item) {
  if (typeof item === "string") {
    const description = INCLUDE_DESCRIPTIONS[item];
    return description ? { label: item, description } : { label: item };
  }
  const label = item.label;
  const description = item.description || INCLUDE_DESCRIPTIONS[label] || undefined;
  return {
    label,
...
function enrichServiceDefaults(s) {
  const included = Array.isArray(s.included)
    ? s.included.map(toIncludeRow)
    : (s.customIncludes ?? []).map(toIncludeRow);
...
const STANDALONE_ENTRIES = [
  ...
  },
  {
    ...
    service: {
      ...
      included: [
        {
          label: "3 קוקטיילים ייחודיים",
          description:
            "תפריט של 3 קוקטיילים מותאמים לאירוע — הכנה במקום, כולל אלכוהול בסיסי ומנות לפי מספר האורחים.",
        },
        {
          label: "ברמן",
          description:
            "ברמן מקצועי לאורך האירוע, כולל הכנת משקאות לפי התפריט ושירות לאורחים.",
        },
        {
          label: "עמדת בר מעוצבת",
          description:
            "עמדת בר מלאה עם כלי הגשה, קרח ועיצוב תואם לסגנון האירוע.",
        },
      ],
      reviews: [],
    },
