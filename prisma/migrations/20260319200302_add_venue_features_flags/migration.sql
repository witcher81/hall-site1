...
INSERT INTO "new_Venue" ("accessible", "address", "boutique", "city", "coverImageUrl", "createdAt", "description", "galleryImageUrls", "id", "kashrut", "maxGuests", "maxPrice", "minGuests", "minPrice", "name", "ownerId", "parking", "seaView", "updatedAt", "venueType") SELECT "accessible", "address", "boutique", "city", "coverImageUrl", "createdAt", "description", "galleryImageUrls", "id", "kashrut", "maxGuests", "maxPrice", "minGuests", "minPrice", "name", "ownerId", "parking", "seaView", "updatedAt", "venueType" FROM "Venue";
DROP TABLE "Venue";
