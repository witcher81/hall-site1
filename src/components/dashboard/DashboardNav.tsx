...
export default function DashboardNav({
  ...
  return (
    <header className="dashboard-nav sticky top-0 z-40 border-b border-white/10 bg-gradient-to-b from-emerald-950 via-emerald-950 to-[#023528] shadow-[0_8px_32px_rgba(2,44,34,0.35)] backdrop-blur-md">
