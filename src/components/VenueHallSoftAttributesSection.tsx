  ...
  return (
    <div>
      ...
      <p className="mb-3 text-[11px] leading-relaxed text-[#6B6560]">
        סימון בלבד — ללא «כלול במחיר» / «בתוספת תשלום». ריקודים, שולחנות, הגברה ואוכל
      ...
      <div className="mt-4 border-t border-[#E0D4C3]/70 pt-3">
        ...
        <p className="mb-2 text-[11px] text-[#6B6560]">
          הוסיפו טקסט קצר (למשל &quot;גג פתוח&quot;, &quot;לובי כפול&quot;). סמנו אם להציג
          למחפשים.
        </p>
            ...
            {customRows.map((row) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={() =>
                    onCustomRowsChange(customRows.filter((r) => r.id !== row.id))
                  }
                >
                  הסר
                </button>
