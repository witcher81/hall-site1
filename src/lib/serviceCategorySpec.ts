...
> = {
  ...
  "בר מתוקים": {
    ...
    packageIncludedTitle: "מתוקים שכלולים",
    packageIncludedHint: "מה כלול במחיר החבילה — ממתקים, שוקולד, פירות.",
  ...
  "עמדת גלידה": {
    ...
    packageNamePlaceholder: "למשל: עמדת גלידה 3 שעות",
    packageIncludedTitle: "טעמי גלידה שכלולים",
    packageIncludedHint: "הטעמים שכלולים במחיר החבילה הזו.",
  ...
  "עמדת וופל בלגי": {
    ...
    packageNamePlaceholder: "למשל: עמדת וופל 3 שעות",
    packageIncludedTitle: "סוגי וופל / תוספות שכלולים",
    packageIncludedHint: "מה כלול במחיר החבילה — סוגי וופל ותוספות בסיס.",
  ...
  "עמדת קרפים": {
    ...
    packageNamePlaceholder: "למשל: עמדת קרפים 3 שעות",
    packagesTitle: "חבילות העמדה",
    packageIncludedTitle: "סוגי קרפים שכלולים",
    packageIncludedHint: "המילויים / סוגי הקרפ שכלולים במחיר החבילה.",
  ...
  "עמדת פופקורן": {
    ...
    packageNamePlaceholder: "למשל: עמדת פופקורן 3 שעות",
    packageIncludedTitle: "טעמי פופקורן שכלולים",
    packageIncludedHint: "הטעמים שכלולים במחיר החבילה הזו.",
  ...
  "עמדת סושי": {
    ...
    packageNamePlaceholder: "למשל: עמדת סושי 3 שעות",
    packageIncludedTitle: "מנות / רולים שכלולים",
    packageIncludedHint: "הרולים והמנות שכלולים במחיר החבילה.",
  ...
  "עוגות לאירועים": {
    editorTitle: "עוגות לאירועים — מחיר וגודל",
    packagesTitle: "גודלי עוגה ומחיר",
    ...
    packageIncludedTitle: "טעמים ועיטורים שכלולים",
    packageIncludedHint: "מה כלול במחיר העוגה הזו — טעמים, עיטורים, שכבות.",
