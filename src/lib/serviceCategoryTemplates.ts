...
const TEMPLATES: Record<CatalogTemplateId, CatalogTemplate> = {
  food: {
    ...
    editorHint:
      "שלב 1: מחיר לאורח (שם + סכום). שלב 2: תפריט המנות למטה — בנפרד.",
    ...
    packagesHint:
      "רק שני דברים לכל שורה: שם (למשל תפריט מבוגרים) + מחיר לאורח. את המנות עצמן מוסיפים למטה בתפריט.",
    ...
    packageDescriptionPlaceholder: "למשל: מנה ראשונה + עיקרית + קינוח",
    catalogTitle: "תפריט — מה כלול",
    catalogHint:
      "רשימת המנות (ראשונות, עיקריות, קינוחים). «כלול» במחיר למעלה, או תוספת לאורח.",
  ...
  beverage: {
    ...
    editorHint:
      "שני חלקים: קודם מחיר השירות לבר (לחבילה / לערב) — אחר כך רשימת המשקאות שכלולים.",
    capacityTitle: "קיבולת אורחים",
    ...
    packagesHint:
      "כאן רושמים כמה עולה הבר לאירוע / לחבילה — לא לאורח. למשל: «בר בסיסי 4 שעות» ₪3,500, «open bar» ₪6,000.",
  ...
  food_station: {
    ...
    catalogTitle: "טעמים ומנות — מה כלול",
    catalogHint: "רשימת טעמים או מנות — כלול במחיר השירות או בתוספת.",
