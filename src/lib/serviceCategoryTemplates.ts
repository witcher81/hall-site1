...
const TEMPLATES: Record<CatalogTemplateId, CatalogTemplate> = {
  food: {
    ...
    editorHint:
      "שני חלקים נפרדים: קודם כמה עולה לאורח — אחר כך מה כלול בתפריט. המחיר לא מחליף את התפריט, והתפריט לא מחליף את המחיר.",
    ...
    packagesHint:
      "כאן רושמים רק כמה זה עולה לאורח אחד — לא את רשימת המנות. למשל: «תפריט מבוגרים» 180₪, «ילדים» 80₪.",
  ...
  beverage: {
    ...
    editorHint:
      "שני חלקים: קודם מחיר לאורח לבר — אחר כך רשימת המשקאות שכלולים.",
    capacityTitle: "קיבולת אורחים",
    capacityHint: "טווח האורחים שאתם משרתים בבר.",
    minCapacityLabel: "מינימום אורחים *",
    maxCapacityLabel: "מקסימום אורחים *",
    packagesTitle: "מחיר לאורח לבר",
    packagesHint:
      "כאן רושמים כמה עולה הבר לאורח — לא את רשימת המשקאות. למשל: «בר בסיסי» 80₪, «open bar» 150₪.",
    packagePriceLabel: "מחיר לאורח (₪)",
    packagePriceExpandLabel: "אין מחיר קבוע — אציג טווח לאורח",
    packageNamePlaceholder: "למשל: בר בסיסי, open bar",
    catalogTitle: "רשימת משקאות — מה כלול",
    catalogHint:
      "כאן רושמים את המשקאות עצמם — קוקטיילים, יינות, בירות, קפה. כלול במחיר מלמעלה או בתוספת.",
