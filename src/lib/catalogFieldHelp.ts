...
const BY_TEMPLATE: Record<CatalogTemplateId, CatalogFieldHelpSet> = {
  ...
  food_station: {
    ...
    packagesSectionBody:
      "שלושה שדות פשוטים: מה אתם מוכרים (למשל עמדת גלידה), לכמה שעות, ומה המחיר. אל תכתבו שעות בשם — יש שדה נפרד. לשולחן שוק: שם האזור + מחיר קבוע לשולחן, ותפריט לפי קבוצות (עיקריות / תוספות / סלטים / רטבים).",
    catalogSectionTitle: "מה זה «תוספות בתשלום»?",
    catalogSectionBody:
      "רק דברים בתוספת מחיר. מה שכלול במחיר נרשם בתוך האפשרות למעלה.",
    packageName: "מה אתם מוכרים — בלי לציין שעות. למשל: «עמדת גלידה» או «שולחן שוק — חולון».",
    packagePrice: "כמה זה עולה לאירוע / לשולחן / לאפשרות הזו.",
    packageDuration: "כמה שעות העמדה פועלת — נפרד מהשם (לא רלוונטי לשולחן שוק).",
