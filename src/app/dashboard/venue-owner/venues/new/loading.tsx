  ...
  return (
    <div className="min-h-screen bg-[#EFE6D5] text-[#1A1A1A]">
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="animate-pulse border-b border-[#E0D4C3] pb-4">
          <div className="ms-auto h-7 w-56 rounded bg-[#D4C9BC]" />
          <div className="ms-auto mt-2 h-3 w-full max-w-md rounded bg-[#E8E4DC]" />
        </div>
        <div className="mt-6 space-y-4 rounded-2xl border border-[#E0D4C3] bg-white p-6 shadow-[0_12px_40px_rgba(15,59,46,0.08)]">
