...
export default function VenueEditForm({
  ...
  const [noUniformMealPrice, setNoUniformMealPrice] = useState(
    () =>
      Boolean(initial.productHasFood) &&
      !String(initial.minPrice ?? "").trim() &&
      !String(initial.maxPrice ?? "").trim()
  );
    ...
    <>
      ...
      <DashboardMain className="max-w-3xl">
        ...
        >
          ...
          <div className="relative z-0 isolate overflow-hidden rounded-xl border border-neutral-200 bg-neutral-50 p-3">
