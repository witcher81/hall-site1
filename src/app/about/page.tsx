...
export const metadata: Metadata = {
  ...
  description:
    "EventForYou מחבר בין מחפשי אולמות אירועים, בעלי אולמות וספקי שירותים בישראל — חיפוש, השוואה ופניות במקום אחד.",
    ...
    <SitePageShell>
      <article className="site-card-padded mx-auto max-w-3xl space-y-5 text-right text-sm leading-relaxed text-[var(--foreground)]">
        ...
        <p>
          ...
          לעזור למחפשים למצוא אולם מתאים, ספקי שירותים וחבילות אירוע — ולעזור
          לבעלי אולמות ולפרילנסרים לקבל פניות איכותיות ולהציג את העסק בצורה
          ברורה ומקצועית.
        </p>
        <p>
        ...
        <ul className="list-inside list-disc space-y-1 text-[var(--muted)]">
          <li>מחפשי אולמות ושירותים לאירועים (חתונות, בר/בת מצווה, אירועים פרטיים ועסקיים)</li>
